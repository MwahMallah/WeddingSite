...
function GuestInvite() {
	...
	useGSAP(
		() => {
			...
			tl.to(".gi-names", { opacity: 1, duration: 0.2, y: 0 })
				.to(".gi-line.top", { opacity: 1, scaleX: 1, duration: 0.15 })
				.to(".gi-line.bottom", { opacity: 1, scaleX: 1, duration: 0.15 })
				.to(".gi-sideText", { opacity: 1, duration: 0.2 })
				.to(".gi-day", { opacity: 1, y: 0, duration: 0.25 })
				.to(".gi-year", { opacity: 1, duration: 0.2 })
				.add(() => {
					let i = 0;
					setTyped("");
				...
				.to({}, { duration: fullText.length * 0.09 })
